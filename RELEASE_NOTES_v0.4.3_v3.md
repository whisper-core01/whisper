...
`APPLY_NOTES.md` documents patch notes and reviewer-alignment diffs. It is included to show how external critique was incorporated into the documentation and Phase 2 plan.
